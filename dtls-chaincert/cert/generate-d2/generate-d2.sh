...
echo '################################'
openssl x509 -req -in csr/server.csr.pem -CA certs/ca.cert.pem -CAkey private/cakey.pem -out certs/server.cert.pem -CAcreateserial -days 3650 -sha256 -extfile server.cnf
...
echo '################################'
openssl x509 -req -in csr/client.csr.pem -CA certs/ca.cert.pem -CAkey private/cakey.pem -out certs/client.cert.pem -CAcreateserial -days 3650 -sha256 -extfile client.cnf
